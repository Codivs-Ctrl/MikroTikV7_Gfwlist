...
```routeros
/tool/fetch url="https://raw.githubusercontent.com/Codivs-Ctrl/MikroTikV7_Gfwlist/main/gfwlist7_domain.rsc" mode=https dst-path=gfwlist7_domain.rsc
:delay 15s
...
on-event="/tool/fetch url=\"https://raw.githubusercontent.com/Codivs-Ctrl/MikroTikV7_Gfwlist/main/gfwlist7_domain.rsc\" mode=https dst-path=gfwlist7_domain.rsc\r\
\n:delay 15s\r\
...
**联系方式**：
- GitHub Issues: [提交问题](https://github.com/Codivs-Ctrl/MikroTikV7_Gfwlist/issues)
...
**测试环境**: RouterOS v7.13  
**作者**: Codivs-Ctrl
**仓库**: https://github.com/Codivs-Ctrl/MikroTikV7_Gfwlist
